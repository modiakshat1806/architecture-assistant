...
import { UploadCloud, FileType2, X, ArrowRight, Loader2 } from "lucide-react";
...
export default function PRDUpload() {
  ...
  try {
    ...
    // --- SAFETY CHECK: Normalize the data before saving ---
    const rawData = result.data || {};
    const safeData = {
      projectName: rawData.projectName || file.name.replace(".pdf", ""),
    ...
    <DashboardLayout>
      <div className="max-w-3xl mx-auto mt-8 font-satoshi animate-in fade-in duration-500">
        <div className="mb-8 text-center md:text-left">
          <h1 className="text-3xl font-bold text-white tracking-tight">Generate Project</h1>
          <p className="text-zinc-400 mt-2">Upload a PRD. Gemini will extract the technical backlog and API contracts.</p>
        </div>
          ...
          >
            <div className="flex flex-col items-center justify-center py-24 px-6 text-center">
              ...
              <p className="text-zinc-400 mb-6 max-w-sm">
                Gemini 3 Flash will analyze your PDF and identify engineering requirements.
              </p>
              ...
              <div className="relative">
                ...
                />
                <Button variant="outline" className="bg-zinc-950 border-zinc-700 text-white hover:bg-zinc-800 font-medium px-8">
                  Browse PDF
                </Button>
              </div>
            </div>
          ...
          <Card className="bg-zinc-900 border-zinc-800 p-6 animate-in slide-in-from-bottom-4">
            <div className="flex items-center justify-between bg-zinc-950 p-4 rounded-xl border border-zinc-800 shadow-sm">
              ...
              <Button 
                ...
                className="text-zinc-500 hover:text-red-400 hover:bg-red-400/10 rounded-full"
              >
                <X className="w-5 h-5" />
              </Button>
            </div>
